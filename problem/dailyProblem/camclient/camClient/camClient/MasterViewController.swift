...
//            print(data)
            ...
            var recievedDouble = Double.init(recievedStr!)
            recDouble = recievedDouble!
            print(recievedDouble)
        }
        
        
        task.resume()
        
        objects.insert(NSDate.init(timeIntervalSinceNow: recDouble), at: 0)
